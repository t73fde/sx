...
func TestReadList(t *testing.T) {
	performReaderTestCases(t, []readerTestCase{
		...
		{name: "SpaceEOF", src: "(1 2 ", exp: "ReaderError 1-5: unexpected EOF", mustErr: true},
		{name: "WithComment", src: "(1 ; one\n a\n µ)", exp: "(1 a µ)"},
		{name: "SimpleDot", src: "(1 . 2)", exp: "(1 . 2)"},
		{name: "ListDot", src: "(1 2 3 . 4)", exp: "(1 2 3 . 4)"},
		{name: "NilDot", src: "(. 2)", exp: "(() . 2)"},
		{name: "DotList", src: "(1 . (2 3))", exp: "(1 2 3)"},
		{name: "DotSpaceNothing", src: "(1 . ", exp: "ReaderError 1-5: unexpected EOF", mustErr: true},
		{name: "DotNoEnd", src: "(1 . 2 ", exp: "ReaderError 1-7: unexpected EOF", mustErr: true},
		{name: "DotMore", src: "(1 . 2 3)", exp: "ReaderError 1-8: ')' (41) expected, but got '3' (51)", mustErr: true},
		{name: "DotEmpty", src: "(1 .)", exp: "ReaderError 1-4: '.' not allowed here", mustErr: true},
		{name: "DotEmptySpace", src: "(1 . )", exp: "ReaderError 1-6: unmatched delimiter ')'", mustErr: true},
	})
}
