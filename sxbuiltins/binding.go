...
// CurrentBinding returns the current frame.
...
// ParentBinding returns the parent frame of the given frame. For the
...
// BindingResolve returns the symbol's bound value in the given frame
