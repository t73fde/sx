...
var tcsSequence = tTestCases{
	...
	{name: "err-length<-0",
		src:     "(length<)",
		exp:     "{[{length<: exactly 2 arguments required, but none given}]}",
		withErr: true,
	},
	{name: "err-length<-1",
		src:     "(length< 1)",
		exp:     "{[{length<: exactly 2 arguments required, but 1 given: [1]}]}",
		withErr: true,
	},
	{name: "err-length<-2",
		src:     "(length< 1 2)",
	...
	{name: "err-length<-nil-nil",
		src:     "(length< () ())",
		exp:     "{[{length<: argument 2 is not a number, but *sx.Pair/()}]}",
		withErr: true,
	},
	...
	{name: "err-nth-0",
		src:     "(nth)",
		exp:     "{[{nth: exactly 2 arguments required, but none given}]}",
		withErr: true,
	},
	{name: "err-nth-1",
		src:     "(nth 1)",
		exp:     "{[{nth: exactly 2 arguments required, but 1 given: [1]}]}",
		withErr: true,
	},
	{name: "err-nth-2",
		src:     "(nth 1 2)",
		exp:     "{[{nth: argument 1 is not a sequence, but sx.Int64/1}]}",
		withErr: true,
	},
	{name: "err-nth-nil-2",
		src:     "(nth () 2)",
		exp:     "{[{nth: index too large: 2 for ()}]}",
		withErr: true,
	},
	{name: "err-nth-lst-2",
		src:     "(nth '(1) ())",
		exp:     "{[{nth: argument 2 is not a number, but *sx.Pair/()}]}",
		withErr: true,
	},
	{name: "err-nth-lst-range",
		src:     "(nth '(1) 1)",
		exp:     "{[{nth: index too large: 1 for (1)}]}",
		withErr: true,
	},
	{name: "err-nth-lst-neg",
		src:     "(nth '(1) -1)",
		exp:     "{[{nth: negative index -1}]}",
		withErr: true,
	},
	{name: "err-nth-vector-2",
		src:     "(nth (vector) 2)",
		exp:     "{[{nth: index too large: 2 for ()}]}",
		withErr: true,
	},
	{name: "err-nth-vector-range",
		src:     "(nth (vector 1) 1)",
		exp:     "{[{nth: index out of range: 1 (max: 0)}]}",
		withErr: true,
	},
	{name: "err-nth-vector-neg",
		src:     "(nth (vector 1) -1)",
		exp:     "{[{nth: index out of range: -1 (max: 0)}]}",
		withErr: true},
	...
	{name: "err-seq->list-0",
		src:     "(seq->list)",
		exp:     "{[{seq->list: exactly 1 arguments required, but none given}]}",
		withErr: true,
	},
	{name: "err-seq->list-1",
		src:     "(seq->list 1)",
		exp:     "{[{seq->list: argument 1 is not a sequence, but sx.Int64/1}]}",
		withErr: true,
	},
