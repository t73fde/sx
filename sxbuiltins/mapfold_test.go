...
var tcsMapFold = tTestCases{
	...
	{name: "err-map-wrong-elem-0",
		src:     "(map - (list \"1\"))",
		exp:     "{[{-: argument 1 is not a number, but sx.String/\"1\"}]}",
		withErr: true,
	},
	{name: "err-map-wrong-elem-1",
		src:     "(map - (list 3 \"1\"))",
		exp:     "{[{-: argument 1 is not a number, but sx.String/\"1\"}]}",
		withErr: true,
	},
	{name: "err-map-wrong-rest",
		src:     "(map - (list* 3 \"1\"))",
		exp:     "{[{-: argument 1 is not a number, but sx.String/\"1\"}]}",
		withErr: true,
	},
	...
	{name: "err-fold-nolst",
		src:     "(fold + 1 2)",
		exp:     "{[{fold: argument 3 is not a list, but sx.Int64/2}]}",
		withErr: true,
	},
	{name: "err-fold-apply",
		src:     "(fold + 1 (list \"2\"))",
		exp:     "{[{+: argument 1 is not a number, but sx.String/\"2\"}]}",
		withErr: true,
	},
	...
	{name: "err-fold-reverse-nolst",
		src:     "(fold-reverse + 1 2)",
		exp:     "{[{fold-reverse: argument 3 is not a list, but sx.Int64/2}]}",
		withErr: true,
	},
	{name: "err-fold-reverse-apply",
		src:     "(fold-reverse + 1 (list \"2\"))",
		exp:     "{[{+: argument 1 is not a number, but sx.String/\"2\"}]}",
		withErr: true,
	},
