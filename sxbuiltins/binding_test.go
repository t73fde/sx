...
var tcsBinding = tTestCases{
	...
	{name: "parent-binding-current", src: "(parent-binding (current-binding))", exp: "()"},
	// {name: "parent-binding-1-root", src: "(parent-binding ROOT)", exp: "#<undefined>"},
	...
	{name: "lookup-a", src: "(let ((a 3)) (binding-lookup 'a))", exp: "3"},
	{name: "lookup-a-2", src: "(let ((a 3)) (binding-lookup 'a (current-binding)))", exp: "3"},
	{name: "lookup-b", src: "(binding-lookup 'b)", exp: "#<undefined>"},
	{name: "lookup-b-2", src: "(binding-lookup 'b (current-binding))", exp: "#<undefined>"},
	...
	{name: "err-resolve-1-nosym-2",
		src:     "(binding-resolve 1 2)",
		exp:     "{[{binding-resolve: argument 1 is not a symbol, but sx.Int64/1}]}",
		withErr: true,
	},
	...
	{name: "resolve-xyz-2", src: "(binding-resolve 'xyz (current-binding))", exp: "#<undefined>"},
}
