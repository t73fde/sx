...
var tcsEnv = tTestCases{
	...
	},
	{
		...
		exp:     "{[{binding-lookup: between 1 and 2 arguments required, but 3 given: [a err-lookup-3-noenv 1]}]}",
		withErr: true,
	},
	...
	},
	{
		...
		exp:     "{[{binding-resolve: between 1 and 2 arguments required, but 3 given: [a err-resolve-3-noenv 1]}]}",
		withErr: true,
	},
