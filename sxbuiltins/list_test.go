...
var tcsList = tTestCases{
	...
	{name: "err-cdr-1",
		src:     "(cdr 1)",
		exp:     "{[{cdr: argument 1 is not a pair, but sx.Int64/1}]}",
		withErr: true,
	},
	...
	{name: "err-cadr-0",
		src:     "(cadr)",
		exp:     "{[{cadr: exactly 1 arguments required, but none given}]}",
		withErr: true,
	},
	{name: "err-cadr-2",
		src:     "(cadr d b)",
		exp:     "{[{cadr: exactly 1 arguments required, but 2 given: [(44 55) 11]}]}",
		withErr: true,
	},
	{name: "err-cadr-nil",
		src:     "(cadr ())",
		exp:     "{[{cadr: argument 1 is not a pair, but *sx.Pair/()}]}",
		withErr: true,
	},
	{name: "err-cadr-cons",
		src:     "(cadr (cons 1 2))",
		exp:     "{[{cadr: pair expected, but got sx.Int64/2}]}",
		withErr: true,
	},
	{name: "err-cadr-cons-cons",
		src:     "(cadr (cons (cons 1 2) 3))",
		exp:     "{[{cadr: pair expected, but got sx.Int64/3}]}",
		withErr: true,
	},
	{name: "cadr-cons-cons", src: "(cadr (cons 1 (cons 2 3)))", exp: "2"},
	...
	{name: "err-list-vector-0",
		src:     "(list->vector)",
		exp:     "{[{list->vector: exactly 1 arguments required, but none given}]}",
		withErr: true,
	},
	{name: "err-list-vector-2",
		src:     "(list->vector d b)",
		exp:     "{[{list->vector: exactly 1 arguments required, but 2 given: [(44 55) 11]}]}",
		withErr: true,
	},
	{name: "err-list-vector-num",
		src:     "(list->vector 1)",
		exp:     "{[{list->vector: argument 1 is not a list, but sx.Int64/1}]}",
		withErr: true,
	},
	{name: "list-vector-nil", src: "(list->vector ())", exp: "()"},
	{name: "list-vector-one", src: "(list->vector (list 1))", exp: "(vector 1)"},
	{name: "list-vector-two", src: "(list->vector (list 1 2))", exp: "(vector 1 2)"},
}
